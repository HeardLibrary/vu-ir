export { MatomoFormAnalyticsModule, MATOMO_FORM_ANALYTICS_DIRECTIVES, } from './matomo-form-analytics.module';
export { withFormAnalytics } from './providers';
export { MatomoFormAnalyticsConfiguration, MATOMO_FORM_ANALYTICS_CONFIGURATION, } from './configuration';
