...
export declare class MatomoTracker {
     ...
     */
    trackEvent(category: string, action: string, name?: string, value?: number, customData?: unknown): void;
    /**
     ...
     */
    enableLinkTracking(usePseudoClickHandler?: boolean): void;
     ...
     *
     */
    setPagePerformanceTiming(networkTimeInMs: number | undefined, serverTimeInMs?: number, transferTimeInMs?: number, domProcessingTimeInMs?: number, domCompletionTimeInMs?: number, onloadTimeInMs?: number): void;
