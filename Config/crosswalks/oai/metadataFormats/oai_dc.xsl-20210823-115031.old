	...
	<xsl:template match="/">
		<oai_dc:dc xmlns:oai_dc="http://www.openarchives.org/OAI/2.0/oai_dc/" 
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='title']/doc:element/doc:field[@name='value']">
				<dc:title type="dcterms:main"><xsl:value-of select="." /></dc:title>
			</xsl:for-each>

			<!-- dc.creator -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='creator']/doc:element/doc:field[@name='value']">
				<dc:creator type="dcterms:author"><xsl:value-of select="." /></dc:creator>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name='advisor']/doc:element/doc:field[@name='value']">
				<dc:contributor type="dcterms:advisor"><xsl:value-of select="." /></dc:contributor>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='contributor']/doc:element[@name='other']/doc:element/doc:field[@name='value']">
				<dc:contributor type="dcterms:other"><xsl:value-of select="." /></dc:contributor>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='subject']/doc:element[@name='lcsh']/doc:element/doc:field[@name='value']">
				<dc:subject type="dcterms:lcsh"><xsl:value-of select="." /></dc:subject>
			</xsl:for-each>
			<!-- dc.subject.mesh -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='subject']/doc:element[@name='mesh']/doc:element/doc:field[@name='value']">
				<dc:subject type="dcterms:mesh"><xsl:value-of select="." /></dc:subject>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='description']/doc:element[@name='abstract']/doc:element/doc:field[@name='value']">
				<dc:description type="dcterms:abstract"><xsl:value-of select="." /></dc:description>
			</xsl:for-each>
			...
			<!-- dc.description.department -->
                        <xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='description']/doc:element[@name='department']/doc:element/doc:field[@name='value']">
                                <dc:description type="dcterms:department"><xsl:value-of select="." /></dc:description>
                        </xsl:for-each>
                        ...
                        <xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='description']/doc:element[@name='college']/doc:element/doc:field[@name='value']">
                                <dc:description type="dcterms:college"><xsl:value-of select="." /></dc:description>
                        </xsl:for-each>
                        ...
                        <xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='description']/doc:element[@name='sponsorship']/doc:element/doc:field[@name='value']">
                                <dc:description type="dcterms:sponsorship"><xsl:value-of select="." /></dc:description>
                        </xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='created']/doc:element/doc:field[@name='value']">
				<dc:date type="dcterms:created"><xsl:value-of select="." /></dc:date>
			</xsl:for-each>
			<!-- dc.date.issued -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='date']/doc:element[@name='issued']/doc:element/doc:field[@name='value']">
				<dc:date type="dcterms:issued"><xsl:value-of select="." /></dc:date>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='identifier']/doc:element[@name='uri']/doc:element/doc:field[@name='value']">
				<dc:identifier type="dcterms:URI"><xsl:value-of select="." /></dc:identifier>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='identifier']/doc:element[@name='citation']/doc:element/doc:field[@name='value']">
				<dc:identifier type="dcterms:citation"><xsl:value-of select="." /></dc:identifier>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='language']/doc:element[@name='iso']/doc:element/doc:field[@name='value']">
				<dc:language type="dcterms:iso"><xsl:value-of select="." /></dc:language>
			</xsl:for-each>
			...
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='ispartofseries']/doc:element/doc:field[@name='value']">
				<dc:relation type="dcterms:ispartofseries"><xsl:value-of select="." /></dc:relation>
			</xsl:for-each>
                        <!-- dc.relation.URI -->
                        <xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='relation']/doc:element[@name='URI']/doc:element/doc:field[@name='value']">
                                <dc:relation type="dcterms:URI"><xsl:value-of select="." /></dc:relation>
                        </xsl:for-each>
			...
			<!-- dc.format.extent -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element[@name='extend']/doc:element/doc:field[@name='value']">
				<dc:format type="dcterms:extend"><xsl:value-of select="." /></dc:format>
			</xsl:for-each>		
			<!-- dc.format.mimetype -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='format']/doc:element[@name='mimetype']/doc:element/doc:field[@name='value']">
				<dc:format type="dcterms:mimetype"><xsl:value-of select="." /></dc:format>
			</xsl:for-each>
			...
			<!-- dc.coverage.spatial -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='coverage']/doc:element/doc:element[@name='spatial']/doc:field[@name='value']">
				<dc:coverage type="dcterms:spatial"><xsl:value-of select="." /></dc:coverage>
			</xsl:for-each>
			<!-- dc.coverage.temporal -->
                        <xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='coverage']/doc:element/doc:element[@name='temporal']/doc:field[@name='value']">
                                <dc:coverage type="dcterms:temporal"><xsl:value-of select="." /></dc:coverage>
                        </xsl:for-each>

			<!-- dc.publisher -->
			<xsl:for-each select="doc:metadata/doc:element[@name='dc']/doc:element[@name='publisher']/doc:element/doc:field[@name='value']">
				<dc:publisher type="dcterms:main"><xsl:value-of select="." /></dc:publisher>
			</xsl:for-each>
			<!-- dc.source -->
