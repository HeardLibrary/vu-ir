...
<!--    <xsl:output indent="yes"/> -->
   ...
   <!-- add static pages --> 
    ...
    <xsl:template name="sign-in-text" match="dri:div[@id='aspect.eperson.LDAPLogin.div.login']/dri:head">
        ...
        <br/>
        <p>Please use your VUNetID and ePassword to sign in to Vanderbilt University Institutional Repository (VUIR).</p>
        <p>If you previously used a different ID and password to access VUIR, you will need to reauthenticate yourself with your VUNetID. Please <a href="mailto:vuir@list.vanderbilt.edu">contact us</a> if you have questions or experience connectivity problems.</p>
        <hr/>
