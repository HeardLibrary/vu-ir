...
<xsl:stylesheet xmlns:i18n="http://apache.org/cocoon/i18n/2.1"
    ...
    <!--
        ...
        This template creates the html document, giving it a head and body. A title and the CSS style reference are placed in the html head, while the body is further split into several divs. The top-level div    directly under html body is called "ds-main". It is further subdivided into:
    ...
    <xsl:template match="dri:document">
        ...
        <xsl:choose>
                            ...
                            <div id="main-container" class="container">
                                <div class="row row-offcanvas row-offcanvas-left">
                                    <div class="horizontal-slider clearfix">
                                        <div class="col-xs-12 col-sm-12 col-md-8 col-md-push-3 main-content">
                                            <xsl:apply-templates select="*[not(self::dri:options)]"/>
                                        </div>
                                        <div class="col-xs-6 col-sm-3 col-sm-pull-9 col-md-3 col-md-pull-8 sidebar-offcanvas" id="sidebar" role="navigation">
                                          <xsl:apply-templates select="dri:options"/>
                                        </div>
                                   </div>
                                </div>

                                <!-- The footer div, dropping whatever extra information is needed on the page. It will most likely be something similar in structure to the currently given example. -->
                            </div><!-- /main-container -->
            ...
            <xsl:otherwise>
            <!-- This is only a starting point. If you want to use this feature you need to implement JavaScript code and a XSLT template by yourself. Currently this is used for the DSpace Value Lookup -->
            ...
            <div class="wrap">
                <div class="footer-top">
                    <div id="footer-callout"> 
                        <a href="https://webapp.mis.vanderbilt.edu/olga/pub/landing?appealCode=Q13A8" class="give-now">Give Now</a>
                ...
                <div class="footer-bottom">
                    <ul id="library-address">
                        <li>Jean and Alexander Heard Library</li>
