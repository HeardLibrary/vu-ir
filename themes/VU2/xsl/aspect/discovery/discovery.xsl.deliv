...
-->
    ...
    <xsl:template match="dri:list/dri:list/dri:list" mode="dsoList" priority="8">
            ...
            <xsl:variable name="externalMetadataURL">
                ...
                <!-- in the revised version, need fileSec to get first mimetype  -->
            ...
            <div class="col-sm-3 hidden-xs">
                ...
                <!-- <xsl:apply-templates select="$metsDoc/mets:METS/mets:fileSec" mode="artifact-preview">  -->
                    <xsl:call-template name="displayItemIcon">
                        <xsl:with-param name="thumbnail_node" select="$metsDoc/mets:METS/mets:fileSec/mets:fileGrp[@USE='THUMBNAIL']" />
                        <xsl:with-param name="mimetype" select="$metsDoc/mets:METS/mets:fileSec/mets:fileGrp[@USE='CONTENT']/mets:file[1]/@MIMETYPE" />  
                        <xsl:with-param name="dctype" select="$metsDoc/mets:METS/mets:dmdSec/mets:mdWrap/
