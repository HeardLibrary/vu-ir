...
<xsl:stylesheet
    ...
    <div class="item-summary-view-metadata">
        ...
        <div class="item-page-field-wrapper row"><!-- files  --> 
        <xsl:call-template name="filelist-details" />
        </div> 

        <div class="item-page-field-wrapper row">
            <h4>This item appears in the following collection(s): </h4>
    ...
    <div class="row"> <!-- title and author -->
        <xsl:call-template name="itemSummaryView-DIM-title"/>
        <xsl:call-template name="itemSummaryView-DIM-authors"/>  
    </div><!-- first row -->

    <div class="row"> <!-- links and pubdate --> 
        <xsl:call-template name="itemSummaryView-DIM-SSRN" />
    ...
    <xsl:template name="itemSummaryView-DIM-abstract">
        <xsl:if test="dim:field[@element='description' and @qualifier='abstract']">
            <div class="simple-item-view-description item-page-field-wrapper table">
                <h4><i18n:text>xmlui.dri2xhtml.METS-1.0.item-abstract</i18n:text></h4>
    ...
    <xsl:template name="itemSummaryView-DIM-authors">
        <xsl:if test="dim:field[@element='contributor'][@qualifier='author' and descendant::text()] or dim:field[@element='creator' and descendant::text()] or dim:field[@element='contributor' and descendant::text()]">
            <div class="simple-item-view-authors item-page-field-wrapper underline-border">
    ...
    <xsl:template name="itemSummaryView-DIM-SSRN">
        <xsl:if test="dim:field[@element='identifier' and @qualifier='ssrn-uri' and descendant::text()]">
            <div class="simple-item-view-uri">
                <label><i18n:text>xmlui.dri2xhtml.METS-1.0.item-ssrn</i18n:text></label>: 
                <span>
                    <xsl:for-each select="dim:field[@element='identifier' and @qualifier='ssrn-uri']">
                        <a>
                        ...
                        <xsl:if test="count(following-sibling::dim:field[@element='identifier' and @qualifier='ssrn-uri']) != 0">
                            <br/>
                        </xsl:if>
                    </xsl:for-each>
                </span>
    ...
    <xsl:template name="itemSummaryView-DIM-URI">
        <xsl:if test="dim:field[@element='identifier' and @qualifier='uri' and descendant::text()]">
            <div class="simple-item-view-uri">
                <label><i18n:text>xmlui.dri2xhtml.METS-1.0.item-persistent</i18n:text></label>: 
                <span>
    ...
    <xsl:template name="filelist-details" >
        <!-- Generate the bitstream information from the file section -->
        <xsl:choose>
   ...
   <xsl:template match="mets:fileGrp[@USE='LICENSE']">
    ...
    <xsl:template name="display-files-in-this-item" match="mets:file"> 
    ...
    <xsl:template name="audioplayer" >
        ...
        <xsl:if test="contains($mimetype, 'audio')">
    ...
    <xsl:template name='impact-altmetric'>
        <div id='impact-altmetric'>
            <!-- Altmetric.com -->
            <script type="text/javascript" src="//d1bxh8uas1mnw7.cloudfront.net/assets/embed.js'">&#xFEFF;
            </script>
            <div id='altmetric'
